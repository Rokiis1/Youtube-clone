...
import {
  ...
  changeSearchTerm,
  clearSearchTerm,
} from "../features/slice/youtubeSlice";
...
const Navigation = () => {
  ...
  return (
    <nav className="flex justify-between items-center px-14 h-14 bg-[#212121] opacity-95 sticky">
      ...
      <div className="flex gap-5 items-center text-xl">
        ...
        <img
          ...
          src="https://lh3.googleusercontent.com/ogw/AOh-ky1iTai8MX83Nr126uDwnu-bTWLWrfKe0iOY73ra=s32-c-mo"
          alt="logo"
        />
      </div>
    </nav>
